...
class qesandans():
    ...
    def run(self):
        ...
        #print(state)
        btn8 = Button(400+self.weight/3, 275+self.height/3, "NEXT", surBtnNormal, surBtnMove, surBtnDown, self.btnCallBack, btnFont, (255, 0, 0))
        #print(state)
        btn1 = Button(self.weight/3-50, 0+self.height/3, "看到不同栅距光栅", surBtnNormal, surBtnMove, surBtnDown, self.btnCallBack1, btnFont, (255, 0, 0))
        btn2 = Button(350+self.weight/3, 0+self.height/3, "未看到不同栅距光栅", surBtnNormal, surBtnMove, surBtnDown, self.btnCallBack2, btnFont, (255, 0, 0))
