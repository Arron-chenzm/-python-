...
class qesandans():
    ...
    def run(self):
        ...
        #print(state)
        btn1 = Button(self.weight/3-50, 0+self.height/3, "看到不同的白噪声", surBtnNorma2, surBtnMove2, surBtnDown2, self.btnCallBack1, btnFont, (255, 0, 0))
        btn2 = Button(350+self.weight/3, 0+self.height/3, "未看到不同的白噪声", surBtnNorma2, surBtnMove2, surBtnDown2, self.btnCallBack2, btnFont, (255, 0, 0))
