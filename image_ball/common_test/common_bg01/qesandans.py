...
class qesandans():
    ...
    def run(self):
        ...
        btn9 = Button(0 + self.weight / 3, 180 + self.height / 3, "thing5", surBtnNormal, surBtnMove, surBtnDown,
                      self.btnCallBack9, btnFont, (255, 0, 0))
        btn10 = Button(125 + self.weight / 3, 180 + self.height / 3, "thing6", surBtnNormal, surBtnMove, surBtnDown,
                      self.btnCallBack10, btnFont, (255, 0, 0))
        btn11 = Button(250 + self.weight / 3, 180 + self.height / 3, "thing7", surBtnNormal, surBtnMove, surBtnDown,
                      self.btnCallBack11, btnFont, (255, 0, 0))
        btn12 = Button(375 + self.weight / 3, 180 + self.height / 3, "thing8", surBtnNormal, surBtnMove, surBtnDown,
                      self.btnCallBack12, btnFont, (255, 0, 0))
        btn13 = Button(0 + self.weight / 3, 260 + self.height / 3, "thing9", surBtnNormal, surBtnMove, surBtnDown,
                       self.btnCallBack13, btnFont, (255, 0, 0))
        btn14 = Button(125 + self.weight / 3, 260 + self.height / 3, "thing10", surBtnNormal, surBtnMove, surBtnDown,
