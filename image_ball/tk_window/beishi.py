...
files = getfiles(Path)
img_open = Image.open(Path+'/'+files[7]).resize((1920,1000),Image.ANTIALIAS)
# img_open = Image.open('D:\\Users\\chen\\Desktop\\figure\\dog2.jpg').resize((1920,1000),Image.ANTIALIAS)
img_png = ImageTk.PhotoImage(img_open)


fm1 = Frame(window,height = 1000, width=1920,bg = 'yellow')
label_image = Label(window,image =img_png,text = '12+23= 53? ',font=('Arial', 225),fg='white',compound = CENTER  ,height = 1000, width=1920)
...
# Button(fm3, text='A 55',font=('Arial', 25),padx = 10,relief = SUNKEN).pack(side=LEFT, fill=BOTH, expand=YES)
# Button(fm3, text='B 30',font=('Arial', 25),padx = 10,relief = SUNKEN).pack(side=LEFT, fill=BOTH, expand=YES)
# Button(fm3, text='C 22',font=('Arial', 25),padx = 10,relief = SUNKEN).pack(side=LEFT, fill=BOTH, expand=YES)
# Button(fm3, text='D 41',font=('Arial', 25),padx = 10,relief = SUNKEN).pack(side=LEFT, fill=BOTH, expand=YES)
